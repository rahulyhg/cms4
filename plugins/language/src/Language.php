...
class Language
{
    ...
    public function getCurrentLocaleName()
    {
        ...
        return array_get($this->supportedLocales, $this->getCurrentLocale() . '.lang_name');
    }
    ...
    public function getCurrentLocaleRTL()
    {
        ...
        return array_get($this->supportedLocales, $this->getCurrentLocale() . '.lang_is_rtl');
    }
    ...
    public function getCurrentLocaleCode()
    {
        ...
        return array_get($this->supportedLocales, $this->getCurrentLocale() . '.lang_code');
    }
    ...
    public function getDefaultLocaleCode()
    {
        ...
        return array_get($this->supportedLocales, $this->getDefaultLocale() . '.lang_code');
    }
    ...
    public function getCurrentLocaleFlag()
    {
        ...
        return array_get($this->supportedLocales, $this->getCurrentLocale() . '.lang_flag');
    }
