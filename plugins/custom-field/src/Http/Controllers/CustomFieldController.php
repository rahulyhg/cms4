...
class CustomFieldController extends BaseController
{
     ...
     * @author Sang Nguyen
     */
    public function postCreate(CreateFieldGroupRequest $request, CreateCustomFieldAction $action, BaseHttpResponse $response)
    {
     ...
     * @author Sang Nguyen, Tedozi Manson
     */
    public function postEdit($id, UpdateFieldGroupRequest $request, UpdateCustomFieldAction $action, BaseHttpResponse $response)
    {
