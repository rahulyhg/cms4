<script id="_options-repeater_template" type="text/x-custom-template">
    <div class="line" data-option="repeater">
        <div class="col-xs-3">
            <h5>{!! trans('plugins.custom-field::base.form.repeater_fields') !!}</h5>
        </div>
        <div class="col-xs-9">
            <h5>{!! trans('plugins.custom-field::base.form.repeater_fields') !!}</h5>
            <div class="add-new-field">
                <ul class="list-group field-table-header clearfix">
                    <li class="col-xs-4 list-group-item w-bold">{!! trans('plugins.custom-field::base.form.field_label') !!}</li>
                    <li class="col-xs-4 list-group-item w-bold">{!! trans('plugins.custom-field::base.form.field_name') !!}</li>
                    <li class="col-xs-4 list-group-item w-bold">{!! trans('plugins.custom-field::base.form.field_type') !!}</li>
                </ul>
...
<script id="_options-defaultvalue_template" type="text/x-custom-template">
    <div class="line" data-option="defaultvalue">
        <div class="col-xs-3">
            <h5>{!! trans('plugins.custom-field::base.form.default_value') !!}</h5>
            <p>{!! trans('plugins.custom-field::base.form.default_value_helper') !!}</p>
        </div>
        <div class="col-xs-9">
            <h5>{!! trans('plugins.custom-field::base.form.default_value') !!}</h5>
...
<script id="_options-placeholdertext_template" type="text/x-custom-template">
    <div class="line" data-option="placeholdertext">
        <div class="col-xs-3">
            <h5>{!! trans('plugins.custom-field::base.form.placeholder') !!}</h5>
            <p>{!! trans('plugins.custom-field::base.form.placeholder_helper') !!}</p>
        </div>
        <div class="col-xs-9">
            <h5>{!! trans('plugins.custom-field::base.form.placeholder') !!}</h5>
            <input type="text" class="form-control" placeholder="" value="">
...
<script id="_options-rows_template" type="text/x-custom-template">
    <div class="line" data-option="rows">
        <div class="col-xs-3">
            <h5>{!! trans('plugins.custom-field::base.form.rows') !!}</h5>
            <p>{!! trans('plugins.custom-field::base.form.rows_helper') !!}</p>
        </div>
        <div class="col-xs-9">
            <h5>{!! trans('plugins.custom-field::base.form.rows') !!}</h5>
...
<script id="_options-selectchoices_template" type="text/x-custom-template">
    <div class="line" data-option="selectchoices">
        <div class="col-xs-3">
            <h5>{!! trans('plugins.custom-field::base.form.choices') !!}</h5>
            <p>{!! trans('plugins.custom-field::base.form.choices_helper') !!}</p>
        </div>
        <div class="col-xs-9">
            <h5>{!! trans('plugins.custom-field::base.form.choices') !!}</h5>
            <textarea class="form-control" rows="5"></textarea>
...
<script id="_options-buttonlabel_template" type="text/x-custom-template">
    <div class="line" data-option="buttonlabel">
        <div class="col-xs-3">
            <h5>{!! trans('plugins.custom-field::base.form.button_label') !!}</h5>
        </div>
        <div class="col-xs-9">
            <h5>{!! trans('plugins.custom-field::base.form.button_label') !!}</h5>
...
<script id="_new-field-source_template" type="text/x-custom-template">
    <li class="ui-sortable-handle active">
        <div class="field-column">
            ...
            <div class="text col-xs-4 field-type">{!! trans('plugins.custom-field::base.form.types.text') !!}</div>
        ...
        <div class="item-details">
            <div class="line" data-option="title">
                <div class="col-xs-3">
                    <h5>{!! trans('plugins.custom-field::base.form.field_label') !!}</h5>
                    <p>{!! trans('plugins.custom-field::base.form.field_label_helper') !!}</p>
                </div>
                <div class="col-xs-9">
                    <h5>{!! trans('plugins.custom-field::base.form.field_label') !!}</h5>
            ...
            <div class="line" data-option="slug">
                <div class="col-xs-3">
                    <h5>{!! trans('plugins.custom-field::base.form.field_name') !!}</h5>
                    <p>{!! trans('plugins.custom-field::base.form.field_name_helper') !!}</p>
                </div>
                <div class="col-xs-9">
                    <h5>{!! trans('plugins.custom-field::base.form.field_name') !!}</h5>
                    <input type="text" class="form-control" placeholder="" value="">
            ...
            <div class="line" data-option="type">
                <div class="col-xs-3">
                    <h5>{!! trans('plugins.custom-field::base.form.field_type') !!}</h5>
                    <p>{!! trans('plugins.custom-field::base.form.field_type_helper') !!}</p>
                </div>
                <div class="col-xs-9">
                    <h5>{!! trans('plugins.custom-field::base.form.field_type') !!}</h5>
            ...
            <div class="line" data-option="instructions">
                <div class="col-xs-3">
                    <h5>{!! trans('plugins.custom-field::base.form.field_instructions') !!}</h5>
                    <p>{!! trans('plugins.custom-field::base.form.field_instructions_helper') !!}</p>
                </div>
                <div class="col-xs-9">
                    <h5>{!! trans('plugins.custom-field::base.form.field_instructions') !!}</h5>
                    <textarea class="form-control" rows="5"></textarea>
