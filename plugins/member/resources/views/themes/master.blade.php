                ...
                <div class="profile-sidebar">
                    <div class="profile-userpic">
                        <a href="{{ route('public.member.avatar') }}">
                            <img src="@if (Auth::guard('member')->user()->avatar) {{ url(Auth::guard('member')->user()->avatar) }} @else https://placehold.it/200x200 @endif" class="userpic-avatar img-responsive" alt="{{ Auth::guard('member')->user()->name }}">
                        </a>
                    </div>
