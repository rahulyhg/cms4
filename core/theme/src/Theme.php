...
class Theme implements ThemeContract
{
    ...
    )
    {
        ...
        $widgets = app(WidgetInterface::class)->getByTheme(setting('theme') . $this->getCurrentLocaleCode());
    ...
    {
        return $this->view->make('core.theme::partials.header')->render();
    }
    ...
    {
        return $this->view->make('core.theme::partials.footer')->render();
    }
    ...
    protected function getCurrentLocaleCode()
    {
        ...
        if (is_plugin_active('language')) {
            $current_locale = \Language::getCurrentAdminLocaleCode();
