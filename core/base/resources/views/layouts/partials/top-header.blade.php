...
<div class="navbar navbar-inverse" role="navigation">
    <div class="navbar-header page-logo">
        ...
        <div class="sidebar-toggle menu-toggler responsive-toggler visible-xs" data-toggle="collapse" data-target=".navbar-collapse">
            <span></span>
        </div>
    ...
    <ul class="nav navbar-nav navbar-right collapse" id="navbar-icons">
        ...
        <li class="dropdown">
            <a class="dropdown-toggle dropdown-header-name" style="padding-right: 10px" href="{{ route('public.index') }}" target="_blank"><i class="fa fa-globe"></i> <span class="hidden-xs">{{ __('View website') }}</span> </a>
        </li>
