...
var BEditor = {
    ...
    initTinyMce: function (element) {
        tinymce.init({
            ...
            min_height: 300,
            resize: 'vertical',
            plugins: 'preview autolink advlist visualchars fullscreen link media template table charmap hr pagebreak nonbreaking anchor insertdatetime lists textcolor wordcount imagetools  contextmenu visualblocks',
            ...
            toolbar: 'formatselect | bold italic strikethrough forecolor backcolor | link | alignleft aligncenter alignright alignjustify  | numlist bullist outdent indent  | removeformat code visualblocks',
            convert_urls: false,
            image_caption: true,
            image_advtab: true,
            image_title: true,
