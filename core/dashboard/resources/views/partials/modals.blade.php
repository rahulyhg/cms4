    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a class="pull-left btn btn-danger" id="hide-widget-confirm-bttn">{{ trans('core.dashboard::dashboard.confirm_hide_btn') }}</a>
                <button class="pull-right btn btn-primary" data-dismiss="modal">{{ trans('core.dashboard::dashboard.cancel_hide_btn') }}</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            {!! Form::open(['route' => 'dashboard.hide_widgets']) !!}
                ...
                <div class="modal-body with-padding">
                    @foreach ($widgets as $widget)
                        ...
                        <section class="wrap_{{ $widget->name }}">
                            ...
                            <span class="widget_name">{{ trans('core.dashboard::dashboard.' . $widget->name) }}</span>
                            <div class="swc_wrap">
                ...
                <div class="modal-footer">
                    <button class="btn btn-default" data-dismiss="modal">{{ trans('core.base::forms.cancel') }}</button>
