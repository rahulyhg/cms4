...
class Setting
{
    ...
    protected function read()
    {
        if (!$this->connected_database) {
            $this->connected_database = check_database_connection();
        }
    ...
    {
        try {
            if (isset($setting['attributes']['options']['placeholder'])) {
                $setting['attributes']['options']['placeholder'] = trans($setting['attributes']['options']['placeholder']);
            }
            ...
            return trans('core.setting::setting.field_type_not_exists');
        }
    }
}
